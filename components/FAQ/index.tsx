...
const FAQSection = () => {
  return (
    <div className="flex md:w-[1136px] md:ml-40 flex-col md:flex-row bg-[#F6F7F9] pb-20 gap-40 md:gap-20 mt-20">
      {/* Left Section */}
      <div className="md:w-[450px] md:h-[692px] ">
        <div className="md:ml-[14px] ml-3">
          <SectionHeading text="FAQ's" className="md:ml-[14px] ml-[2rem]" align="left" />
          {/* <Heading text1="Have questions, "className1="md:ml-0 ml-[1.5rem]" text2="We got answers." className2="md:ml-0 ml-[1.5rem]"  align="left" /> */}
          <h1 className="text-4xl ml-0 font-bold text-[#2D2F33]">Have questions</h1>
          <h1 className="text-4xl ml-0 font-bold text-[#7B8398]">We got answers.</h1>
        </div>
        <p className="md:ml-[14px] mx-3 mt-5 text-[#50576B] text-sm text-left">
          Everything you need to know about our process, and how we deliver
          results.
        </p>
        <div className="md:mt-[22rem] mt-10 bg-white md:w-[28.125rem] w-[23rem] min-h-[10.75rem] md:ml-0 ml-2 rounded-3xl p-7 shadow-md">
      ...
      <div className="flex-1 md:mt-10 mt-[-10rem]">
        <Accordion
          ...
          collapsible
          defaultValue="item-0"
          className="md:w-[570px] w-[350px] md:mx-10 mx-4"
        >
          {faqs.map((faq, index) => (
