  ...
  return (
    <div className="bg-white pt-0">
      ...
      <div className="w-full bg-white px-6 py-10 text-center flex flex-col items-center">
        ...
        <div className="flex items-center justify-center gap-14 mt-4 mb-10 max-w-14 md:max-w-xl">
          <Image
            src="/NTPC.png"
            alt=""
            width={100}
      ...
      {/* Footer Grid */}
      <footer className="bg-white text-[#50576B] max-w-6xl md:ml-36 mx-5">
        {/* Top Section */}
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-[1fr_1.25fr_1fr] gap-x-16 gap-y-10 px-6 pt-14">
          {/* Company Info */}
          <div className="space-y-4 md:max-w-xs pr-4">
            <Image
              src=""
              alt="Sparkradix Logo"
              width={160}
